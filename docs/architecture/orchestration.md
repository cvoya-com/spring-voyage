...
>
> See [ADR-0039 § 3](../decisions/0039-units-are-agents.md#3-children-are-exposed-as-orchestration-tools-to-the-runtime) for the orchestration-tool surface (`list_members`, `inspect`, `delegate_to`, `fanout_to`, `query_status`) and [ADR-0039 § 4](../decisions/0039-units-are-agents.md#4-orchestration-decisions-are-first-class-evidence) for the `OrchestrationDecision` event shape. The current narrative lives in [Units & Agents](units.md) and [Agents](agents.md).
