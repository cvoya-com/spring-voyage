...
- **Related ADRs:** [0035](0035-package-as-bundling-unit.md) — Package as the unit of bundling (parent — extends decisions 2 + 3); [0034](0034-oss-dogfooding-unit.md) — OSS dogfooding unit (forcing function, again); [0017](archive/0017-unit-is-an-agent-composite.md) — Unit is an agent composite (archived; superseded by [0070](0070-subjects-agents-humans-teams.md)).
