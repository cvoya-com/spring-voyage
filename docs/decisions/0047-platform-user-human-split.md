...
- **Tracks:** [#2487](https://github.com/cvoya-com/spring-voyage/issues/2487) (umbrella; sub-issues filed against this umbrella after this ADR lands per the plan-of-record under [`docs/archive/plan/v0.1/platform-user-split.md`](../archive/plan/v0.1/platform-user-split.md)).
