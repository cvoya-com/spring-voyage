...
- **Related ADRs:** [0037](0037-package-schema-decomposition.md) — Package schema decomposition (parent — this ADR extends decisions 1 and 2); [0035](0035-package-as-bundling-unit.md) — Package as the unit of bundling; [0039](archive/0039-units-are-agents.md) — Units are agents (forcing function for uniform folder shape).
