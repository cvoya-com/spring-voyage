...
| [0066](0066-human-hat-survives-unit-relay.md) | A human's "hat" identity survives a unit/agent relay; the runtime never asserts a `human:` sender | Proposed — extends [0062](0062-tenant-user-human-explicit-binding.md) to the runtime egress ([#3001](https://github.com/cvoya-com/spring-voyage/issues/3001)) |
