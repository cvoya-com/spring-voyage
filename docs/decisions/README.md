...
| [0009](0009-manifest-orchestration-strategy-selector.md) | Manifest-driven orchestration-strategy selection resolves per message | Accepted — manifest key > policy inference > unkeyed default; per-message scope |
