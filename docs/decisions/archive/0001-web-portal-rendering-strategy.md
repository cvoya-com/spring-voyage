...
The `eng/build/Dockerfile` comment claiming the build expects `output: "standalone"` is stale and will be corrected as follow-up tidy-up — it is not part of this decision.
