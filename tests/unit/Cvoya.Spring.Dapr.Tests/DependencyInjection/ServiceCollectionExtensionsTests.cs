...
public class ServiceCollectionExtensionsTests
{
    ...
    /// <summary>
    /// ADR-0039 D2 (as amended 2026-05-19, #2536): <c>AddCvoyaSpringDapr</c>
    ...
    /// the directory-backed provider, which returns the closed five-tool
    /// set for every agent:// or unit:// address (no membership gate, no
    /// entity-type gate).
    /// </summary>
    [Fact]
