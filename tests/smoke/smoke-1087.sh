#!/usr/bin/env bash
# tests/smoke/smoke-1087.sh — end-to-end conformance smoke for the unified
...
#     gated behind `SMOKE_DAPR=1` in tests/smoke/smoke-agent-images.sh
...
# `bash tests/smoke/smoke-1087.sh` invocation in .github/workflows/ci.yml
...
# enable this leg by default. tests/smoke/smoke-agent-images.sh shares
