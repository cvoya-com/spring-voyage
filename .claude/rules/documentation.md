...
5. **Non-trivial design decisions get an ADR.** Use the [`architect`](../agents/architect.md) agent for the design pass and [`/adr-new`](../commands/adr-new.md) to scaffold. ADRs live in [`docs/decisions/`](../../docs/decisions/README.md).
