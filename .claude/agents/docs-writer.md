...
- Cross-link aggressively — if a concept doc mentions actors, link to `docs/architecture/units-and-agents.md`. If a guide references a CLI command, link to `docs/cli-reference.md`.
