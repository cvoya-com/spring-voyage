#!/usr/bin/env bash
# eng/release/extract-changelog-section.sh — extract a named section from CHANGELOG.md
#
...
#
# Usage:
#   eng/release/extract-changelog-section.sh [SECTION]
#
# SECTION defaults to "Unreleased". To extract a specific version:
#   eng/release/extract-changelog-section.sh "1.0.0"
#
