...
/// <see cref="ArtefactValidationCompletion"/>. Dapr remoting uses
...
/// <param name="Code">A stable identifier from <see cref="ArtefactValidationCodes"/> — the value consumers should branch on.</param>
...
[DataContract]
public record ArtefactValidationError(
    [property: DataMember(Order = 0)] ArtefactValidationStep Step,
