...
export interface paths {
    ...
    "/api/v1/tenant/units/{id}/members/humans": {
         ...
         * @description Returns the rows from `unit_memberships_humans` for the unit in stable (created_at, id) order. Mirror of `sv.directory.list`'s human entries. Viewer-gated.
         */
