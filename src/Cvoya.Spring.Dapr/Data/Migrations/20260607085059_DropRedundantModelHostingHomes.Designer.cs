...
namespace Cvoya.Spring.Dapr.Data.Migrations
{
    ...
    [Migration("20260607085059_DropRedundantModelHostingHomes")]
    partial class DropRedundantModelHostingHomes
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Cvoya.Spring.Dapr.Data.Entities.ActivityEventRecord", b =>
                {
                    ...
                    b.HasIndex("TenantId", "SourceId", "Timestamp")
            ...
            modelBuilder.Entity("Cvoya.Spring.Dapr.Data.Entities.AgentToolGrantEntity", b =>
                {
                    b.Property<Guid>("TenantId")
                        .HasColumnType("uuid")
                        .HasColumnName("tenant_id");
            ...
            modelBuilder.Entity("Cvoya.Spring.Dapr.Data.Entities.ConnectorDefinitionEntity", b =>
                {
                    ...
                    b.Property<string>("ToolNamespace")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasMaxLength(64)
                        .HasColumnType("character varying(64)")
            ...
            modelBuilder.Entity("Cvoya.Spring.Dapr.Data.Entities.IssueEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "SubjectKind", "SubjectId", "ClearedAt");

                    b.HasIndex("TenantId", "SubjectKind", "SubjectId", "Source", "Code")
                        .IsUnique()
                        .HasFilter("\"ClearedAt\" IS NULL");

                    b.ToTable("Issues", "spring");
                });

            modelBuilder.Entity("Cvoya.Spring.Dapr.Data.Entities.MemoryEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("OwnerScheme")
                        .IsRequired()
                        .HasMaxLength(16)
                        .HasColumnType("character varying(16)")
                        .HasColumnName("owner_scheme");
                    ...
                    b.HasIndex("TenantId", "OwnerScheme", "OwnerId", "CreatedAt")
                        .HasDatabaseName("ix_memories_tenant_owner_created");

                    b.HasIndex("TenantId", "OwnerScheme", "OwnerId", "ThreadId")
                        .HasDatabaseName("ix_memories_tenant_owner_thread");

                    b.ToTable("memories", "spring");
                });
            ...
            modelBuilder.Entity("Cvoya.Spring.Dapr.Data.Entities.SlackThreadStateEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("BoundTenantUserId")
                        .HasColumnType("uuid")
                    ...
                    b.Property<Guid>("SvThreadId")
                        .HasColumnType("uuid")
                        .HasColumnName("sv_thread_id");
                    ...
                    b.HasIndex("TenantId", "TeamId", "SlackThreadTs")
                        .IsUnique()
                        .HasDatabaseName("ux_slack_thread_ts_inbound");

                    b.HasIndex("TenantId", "SvThreadId", "BoundTenantUserId", "TeamId")
                        .IsUnique()
                        .HasDatabaseName("ux_slack_thread_ts_outbound");

                    b.ToTable("slack_thread_ts", "spring");
                });

            modelBuilder.Entity("Cvoya.Spring.Dapr.Data.Entities.TenantActivitySettingsEntity", b =>
                {
                    b.Property<Guid>("TenantId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<string>("ExternalForwardConfig")
                        .HasColumnType("jsonb")
                    ...
                    b.ToTable("tenant_activity_settings", "spring");
                });

            modelBuilder.Entity("Cvoya.Spring.Dapr.Data.Entities.TenantConnectorBindingEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("tenant_connector_bindings", "spring");
                });
            ...
            modelBuilder.Entity("Cvoya.Spring.Dapr.Data.Entities.TenantUserEntity", b =>
                {
                    ...
                    b.Property<Guid?>("PrimaryHumanId")
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("Cvoya.Spring.Dapr.Data.Entities.ThreadEntity", b =>
                {
                    ...
                    b.Property<string>("ParticipantNameSnapshots")
                        .IsRequired()
                        .ValueGeneratedOnAdd()
                        .HasColumnType("jsonb")
                        .HasDefaultValue("{}")
            ...
            modelBuilder.Entity("Cvoya.Spring.Dapr.Data.Entities.UnitMembershipHumanEntity", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.ToTable("unit_memberships_humans", "spring");
                });
            ...
            modelBuilder.Entity("Cvoya.Spring.Dapr.Data.Entities.UnitToolGrantEntity", b =>
                {
                    b.Property<Guid>("TenantId")
                        .HasColumnType("uuid")
                        .HasColumnName("tenant_id");
                    ...
                    b.HasKey("TenantId", "UnitId", "ToolName", "Provenance");
                    ...
                    b.HasIndex("TenantId", "UnitId", "Provenance")
                        .HasDatabaseName("ix_unit_tool_grants_tenant_unit_provenance");

                    b.ToTable("unit_tool_grants", "spring");
                });
