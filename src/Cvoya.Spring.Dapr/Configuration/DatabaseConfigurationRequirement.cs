    ...
    DatabaseConfigurationRequirement.TestHarnessSignal signal) : IConfigurationRequirement
{
    ...
    public Uri? DocumentationUrl { get; } =
        new Uri("https://github.com/cvoya-com/spring-voyage/blob/main/eng/deploy/README.md", UriKind.Absolute);
        ...
        if (string.IsNullOrWhiteSpace(connectionString))
        {
            return Task.FromResult(ConfigurationRequirementStatus.Invalid(
                ...
                suggestion:
                    ...
                    "ConnectionStrings__SpringDb=...) to a valid PostgreSQL connection string. See eng/deploy/README.md.",
