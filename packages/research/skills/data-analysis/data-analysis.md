...
3. Execute the analysis. Record each run with `research.record_experiment` so parameters, code, and results stay reproducible; include deviations from the plan explicitly
